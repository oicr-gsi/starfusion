 ...
 * @author alka
 */
public class STARfusionWorkflowClientTest {

    public STARfusionWorkflowClientTest() {
    }
    ...
    public void validateRegressionTestDefinition() throws IllegalAccessException, InstantiationException, IOException, Exception {
        ...
        for (TestDefinition.Test t : td.getTests()) {
            DryRun d = new DryRun(System.getProperty("bundleDirectory"), t.getParameters(), STARfusionWorkflowClient.class);
